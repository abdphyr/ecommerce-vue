<template>
  <div class="bg-gray-200">
    <div class="border py-3 container mx-auto">
      <div class="flex justify-between">
        ...
        <div class="hidden ml-6 md:flex flex-1 gap-x-3">
          <!-- <div
        ...
        <div class="ml-2 flex">
          <div class="flex cursor-pointer items-center gap-x-1 rounded-md py-0 px-0  md:py-2 md:px-4 hover:bg-white">
            ...
            <span class="hidden lg:block text-sm font-medium">Orders</span>
          </div>
          ...
          <div class="flex cursor-pointer items-center gap-x-1 rounded-md py-0 px-0  md:py-2 md:px-4 hover:bg-white">
            ...
            <span class="hidden lg:block text-sm font-medium">Favorites</span>
          </div>
          ...
          <div class="ml-2 flex cursor-pointer items-center gap-x-1 rounded-md border py-2 px-4 hover:bg-white">
      ...
      <div class="mt-4 flex items-center justify-between">
        <div class="flex gap-x-2 py-1 px-2">
          ...
          <tags-comp />
        <span class="cursor-pointer rounded-sm py-1 px-2 text-sm font-medium hover:bg-white">Becoma a seller</span>
      </div>
    </div>
  </div>
</template>
